<template>
  <div v-if="playlist" class="mb-8 playlist-info">
    <glow-image :height="250" :src="itemImage(playlist)" :width="250" class="mb-4" rounding="5px" />
    <spacer />
    ...
    <p class="playlist-stats">
      Created by
      <router-link :style="{ color: ui.themeColor }" :to="itemUrl(playlist.owner)" class="user-url"
