<template>
  <v-dialog v-model="editDialog.show" :class="{ dark: ui.isDark }" :scrollable="true" width="auto">
    ...
    <div v-else-if="editDialog.likedTrack && editDialog.trackData && track" class="translucent">
      ...
      <v-card-actions class="mt-1">
        <spacer></spacer>
        <v-btn :color="ui.themeColor" variant="tonal" @click="applyChanges"> Apply Changes </v-btn>
